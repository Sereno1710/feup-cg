...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.unitcubequad = new MyUnitCubeQuad(this, this.textureSide, this.textureSide, this.textureTop, this.textureSide, this.textureBottom, this.textureSide);
